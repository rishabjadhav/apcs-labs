...
public abstract class Sprite
{
	...
	public boolean overlaps(Sprite other) {
		if (this.getX() - (this.getWidth() / 2) < other.getX() + (other.getWidth() / 2)) {
			if (other.getX() - (other.getWidth() / 2) < this.getX() + (this.getWidth() / 2)) {
				if (this.getY() + (this.getHeight() / 2) > other.getY() - (other.getHeight() / 2)) {
					if (other.getY() + (other.getHeight() / 2) > this.getY() - (this.getHeight() / 2)) {
						return true;
					}
				}
			}
